...
#include "MultiplayerSessions/Public/MultiplayerSessionsGISubsystem.h"
#include "../../Source/Runtime/Engine/Classes/Engine/GameInstance.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMultiplayerSessionsGISubsystem() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UGameInstanceSubsystem();
	MULTIPLAYERSESSIONS_API UClass* Z_Construct_UClass_UMultiplayerSessionsGISubsystem();
...
#endif
		{ "ModuleRelativePath", "Public/MultiplayerSessionsGISubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "//custom delegates for menu" },
#endif
	};
#endif
...
void FMultiplayerOnStartSessionComplete_DelegateWrapper(const FMulticastScriptDelegate& MultiplayerOnStartSessionComplete, bool bWasSuccessful)
{
	...
	void UMultiplayerSessionsGISubsystem::StaticRegisterNativesUMultiplayerSessionsGISubsystem()
	{
	}
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMultiplayerSessionsGISubsystem);
	UClass* Z_Construct_UClass_UMultiplayerSessionsGISubsystem_NoRegister()
	{
		return UMultiplayerSessionsGISubsystem::StaticClass();
	}
	struct Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UGameInstanceSubsystem,
		(UObject* (*)())Z_Construct_UPackage__Script_MultiplayerSessions,
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "MultiplayerSessionsGISubsystem.h" },
		{ "ModuleRelativePath", "Public/MultiplayerSessionsGISubsystem.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UMultiplayerSessionsGISubsystem>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::ClassParams = {
		&UMultiplayerSessionsGISubsystem::StaticClass,
		nullptr,
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::Class_MetaDataParams)
	};
	UClass* Z_Construct_UClass_UMultiplayerSessionsGISubsystem()
	{
		if (!Z_Registration_Info_UClass_UMultiplayerSessionsGISubsystem.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UMultiplayerSessionsGISubsystem.OuterSingleton, Z_Construct_UClass_UMultiplayerSessionsGISubsystem_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UMultiplayerSessionsGISubsystem.OuterSingleton;
	}
	template<> MULTIPLAYERSESSIONS_API UClass* StaticClass<UMultiplayerSessionsGISubsystem>()
	{
		return UMultiplayerSessionsGISubsystem::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMultiplayerSessionsGISubsystem);
	UMultiplayerSessionsGISubsystem::~UMultiplayerSessionsGISubsystem() {}
	struct Z_CompiledInDeferFile_FID_Users_Caleb_Documents_Unreal_Projects_HordeShooterRepo_HordeShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsGISubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Caleb_Documents_Unreal_Projects_HordeShooterRepo_HordeShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsGISubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMultiplayerSessionsGISubsystem, UMultiplayerSessionsGISubsystem::StaticClass, TEXT("UMultiplayerSessionsGISubsystem"), &Z_Registration_Info_UClass_UMultiplayerSessionsGISubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiplayerSessionsGISubsystem), 4224588658U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Caleb_Documents_Unreal_Projects_HordeShooterRepo_HordeShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsGISubsystem_h_401830852(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_Users_Caleb_Documents_Unreal_Projects_HordeShooterRepo_HordeShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsGISubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Caleb_Documents_Unreal_Projects_HordeShooterRepo_HordeShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsGISubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
