...
// End Cross Module References
	...
	struct PlayerInterface_eventGetMeleeProfile_Parms
	{
		UMSD_MeleeAttackProfile* ReturnValue;

		/** Constructor, initializes return property only **/
		PlayerInterface_eventGetMeleeProfile_Parms()
			: ReturnValue(NULL)
		{
		}
	};
	...
	struct PlayerInterface_eventSetHudVisibility_Parms
	{
	...
	UMSD_MeleeAttackProfile* IPlayerInterface::GetMeleeProfile() const
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_GetMeleeProfile instead.");
		PlayerInterface_eventGetMeleeProfile_Parms Parms;
		return Parms.ReturnValue;
	}
	...
	void IPlayerInterface::SetHudVisibility(ESlateVisibility Visibility)
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_SetHudVisibility instead.");
	}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPlayerInterface_GetInputActionValue_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "//A C++ version of the blueprint function that returns the player's input action value.\n//This is nice because it allows me to get the value I want based on a class variable,\n//instead of each InputAction having its own function like with the BP version\n" },
#endif
		{ "ModuleRelativePath", "HordeShooter/Interfaces/PlayerInterface.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "A C++ version of the blueprint function that returns the player's input action value.\nThis is nice because it allows me to get the value I want based on a class variable,\ninstead of each InputAction having its own function like with the BP version" },
#endif
	};
#endif
	...
	struct Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics
	{
		static const UECodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PlayerInterface_eventGetMeleeProfile_Parms, ReturnValue), Z_Construct_UClass_UMSD_MeleeAttackProfile_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Interfaces/PlayerInterface.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPlayerInterface, nullptr, "GetMeleeProfile", nullptr, nullptr, Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::PropPointers), sizeof(PlayerInterface_eventGetMeleeProfile_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::PropPointers) < 2048);
	static_assert(sizeof(PlayerInterface_eventGetMeleeProfile_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPlayerInterface_GetMeleeProfile_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics
	{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::NewProp_Visibility_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::NewProp_Visibility = { "Visibility", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PlayerInterface_eventSetHudVisibility_Parms, Visibility), Z_Construct_UEnum_UMG_ESlateVisibility, METADATA_PARAMS(0, nullptr) }; // 1295612096
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::NewProp_Visibility_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::NewProp_Visibility,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Interfaces/PlayerInterface.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPlayerInterface, nullptr, "SetHudVisibility", nullptr, nullptr, Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::PropPointers), sizeof(PlayerInterface_eventSetHudVisibility_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::PropPointers) < 2048);
	static_assert(sizeof(PlayerInterface_eventSetHudVisibility_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UPlayerInterface_SetHudVisibility()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPlayerInterface_SetHudVisibility_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	static FName NAME_UPlayerInterface_GetMeleeProfile = FName(TEXT("GetMeleeProfile"));
	UMSD_MeleeAttackProfile* IPlayerInterface::Execute_GetMeleeProfile(const UObject* O)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UPlayerInterface::StaticClass()));
		PlayerInterface_eventGetMeleeProfile_Parms Parms;
		UFunction* const Func = O->FindFunction(NAME_UPlayerInterface_GetMeleeProfile);
		if (Func)
		{
			const_cast<UObject*>(O)->ProcessEvent(Func, &Parms);
		}
		...
		{
			Parms.ReturnValue = I->GetMeleeProfile_Implementation();
		}
		return Parms.ReturnValue;
	}
	...
	static FName NAME_UPlayerInterface_SetHudVisibility = FName(TEXT("SetHudVisibility"));
	void IPlayerInterface::Execute_SetHudVisibility(UObject* O, ESlateVisibility Visibility)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UPlayerInterface::StaticClass()));
		PlayerInterface_eventSetHudVisibility_Parms Parms;
		UFunction* const Func = O->FindFunction(NAME_UPlayerInterface_SetHudVisibility);
		if (Func)
		{
		...
		{
			I->SetHudVisibility_Implementation(Visibility);
		}
	}
