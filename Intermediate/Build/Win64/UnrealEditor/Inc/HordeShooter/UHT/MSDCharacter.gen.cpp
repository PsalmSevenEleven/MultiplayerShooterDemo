...
// End Cross Module References
	DEFINE_FUNCTION(AMSDCharacter::execClearCombo_Implementation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AMSDCharacter::execAddStrikeToCombo_Implementation)
	{
	...
	DEFINE_FUNCTION(AMSDCharacter::execGetComboStrikes_Implementation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AMSDCharacter::execSetComboTimer_Implementation)
	{
	...
	DEFINE_FUNCTION(AMSDCharacter::execGetMeleeProfile_Implementation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(UMSD_MeleeAttackProfile**)Z_Param__Result=P_THIS->GetMeleeProfile_Implementation();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AMSDCharacter::execGetMouseDirection_Implementation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AMSDCharacter::execGetCurrentWidget_Implementation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AMSDCharacter::execGetAbilitySystemComponent)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	void AMSDCharacter::StaticRegisterNativesAMSDCharacter()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "AddStrikeToCombo_Implementation", &AMSDCharacter::execAddStrikeToCombo_Implementation },
			{ "CanInteract_Implementation", &AMSDCharacter::execCanInteract_Implementation },
			{ "ChangeClass", &AMSDCharacter::execChangeClass },
			{ "ClearCombo_Implementation", &AMSDCharacter::execClearCombo_Implementation },
			{ "GetAbilitySystemComponent", &AMSDCharacter::execGetAbilitySystemComponent },
			{ "GetCameraComponent_Implementation", &AMSDCharacter::execGetCameraComponent_Implementation },
			{ "GetComboStrikes_Implementation", &AMSDCharacter::execGetComboStrikes_Implementation },
			...
			{ "GetMeleeProfile_Implementation", &AMSDCharacter::execGetMeleeProfile_Implementation },
			{ "GetMouseDirection_Implementation", &AMSDCharacter::execGetMouseDirection_Implementation },
			...
			{ "SetComboTimer_Implementation", &AMSDCharacter::execSetComboTimer_Implementation },
	...
	struct Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics
	{
		struct MSDCharacter_eventAddStrikeToCombo_Implementation_Parms
		{
			int32 Strike;
		};
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::NewProp_Strike = { "Strike", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventAddStrikeToCombo_Implementation_Parms, Strike), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::NewProp_Strike,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "AddStrikeToCombo_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::MSDCharacter_eventAddStrikeToCombo_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::MSDCharacter_eventAddStrikeToCombo_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "ClearCombo_Implementation", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics
	{
		struct MSDCharacter_eventGetAbilitySystemComponent_Parms
		{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventGetAbilitySystemComponent_Parms, ReturnValue), Z_Construct_UClass_UAbilitySystemComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::NewProp_ReturnValue_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "GetAbilitySystemComponent", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::MSDCharacter_eventGetAbilitySystemComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::MSDCharacter_eventGetAbilitySystemComponent_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics
	{
		struct MSDCharacter_eventGetCameraComponent_Implementation_Parms
		{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventGetCameraComponent_Implementation_Parms, ReturnValue), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::NewProp_ReturnValue_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Player Interface\n" },
#endif
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Player Interface" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "GetCameraComponent_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::MSDCharacter_eventGetCameraComponent_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::MSDCharacter_eventGetCameraComponent_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics
	{
		struct MSDCharacter_eventGetComboStrikes_Implementation_Parms
		{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventGetComboStrikes_Implementation_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::NewProp_ReturnValue_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "GetComboStrikes_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::MSDCharacter_eventGetComboStrikes_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::MSDCharacter_eventGetComboStrikes_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics
	{
		struct MSDCharacter_eventGetCurrentWidget_Implementation_Parms
		{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventGetCurrentWidget_Implementation_Parms, ReturnValue), Z_Construct_UClass_UMSDUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::NewProp_ReturnValue_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "GetCurrentWidget_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::MSDCharacter_eventGetCurrentWidget_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::MSDCharacter_eventGetCurrentWidget_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_GetCurrentWidget_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics
	{
		struct MSDCharacter_eventGetMeleeProfile_Implementation_Parms
		{
			UMSD_MeleeAttackProfile* ReturnValue;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventGetMeleeProfile_Implementation_Parms, ReturnValue), Z_Construct_UClass_UMSD_MeleeAttackProfile_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "GetMeleeProfile_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::MSDCharacter_eventGetMeleeProfile_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::MSDCharacter_eventGetMeleeProfile_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics
	{
		struct MSDCharacter_eventGetMouseDirection_Implementation_Parms
		{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventGetMouseDirection_Implementation_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "GetMouseDirection_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::MSDCharacter_eventGetMouseDirection_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::MSDCharacter_eventGetMouseDirection_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Interact Interface\n" },
#endif
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Interact Interface" },
#endif
	};
#endif
	...
	struct Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics
	{
		struct MSDCharacter_eventSetComboTimer_Implementation_Parms
		{
			float Duration;
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventSetComboTimer_Implementation_Parms, Duration), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventSetComboTimer_Implementation_Parms, ReturnValue), Z_Construct_UScriptStruct_FTimerHandle, METADATA_PARAMS(0, nullptr) }; // 3999327403
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::NewProp_Duration,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "SetComboTimer_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::MSDCharacter_eventSetComboTimer_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::MSDCharacter_eventSetComboTimer_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics
	{
		struct MSDCharacter_eventSetCurrentWidget_Implementation_Parms
		{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::NewProp_NewWidget_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::NewProp_NewWidget = { "NewWidget", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MSDCharacter_eventSetCurrentWidget_Implementation_Parms, NewWidget), Z_Construct_UClass_UMSDUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::NewProp_NewWidget_MetaData), Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::NewProp_NewWidget_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::NewProp_NewWidget,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMSDCharacter, nullptr, "SetCurrentWidget_Implementation", nullptr, nullptr, Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::MSDCharacter_eventSetCurrentWidget_Implementation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::MSDCharacter_eventSetCurrentWidget_Implementation_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMSDCharacter_SetCurrentWidget_Implementation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MeleeProfile_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_MeleeProfile;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMSDCharacter_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AMSDCharacter_AddStrikeToCombo_Implementation, "AddStrikeToCombo_Implementation" }, // 1119815553
		...
		{ &Z_Construct_UFunction_AMSDCharacter_ClearCombo_Implementation, "ClearCombo_Implementation" }, // 2943651329
		{ &Z_Construct_UFunction_AMSDCharacter_GetAbilitySystemComponent, "GetAbilitySystemComponent" }, // 531802413
		{ &Z_Construct_UFunction_AMSDCharacter_GetCameraComponent_Implementation, "GetCameraComponent_Implementation" }, // 1609821890
		{ &Z_Construct_UFunction_AMSDCharacter_GetComboStrikes_Implementation, "GetComboStrikes_Implementation" }, // 1983321755
		...
		{ &Z_Construct_UFunction_AMSDCharacter_GetMeleeProfile_Implementation, "GetMeleeProfile_Implementation" }, // 2387502741
		{ &Z_Construct_UFunction_AMSDCharacter_GetMouseDirection_Implementation, "GetMouseDirection_Implementation" }, // 4065461408
		...
		{ &Z_Construct_UFunction_AMSDCharacter_SetComboTimer_Implementation, "SetComboTimer_Implementation" }, // 840985975
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMSDCharacter_Statics::NewProp_MeleeProfile_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "MSDCharacter" },
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AMSDCharacter_Statics::NewProp_MeleeProfile = { "MeleeProfile", nullptr, (EPropertyFlags)0x0014000000000014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMSDCharacter, MeleeProfile), Z_Construct_UClass_UMSD_MeleeAttackProfile_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMSDCharacter_Statics::NewProp_MeleeProfile_MetaData), Z_Construct_UClass_AMSDCharacter_Statics::NewProp_MeleeProfile_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMSDCharacter_Statics::NewProp_AttributeSet_MetaData[] = {
		{ "Category", "MSDCharacter" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "HordeShooter/Character/MSDCharacter.h" },
		{ "NativeConst", "" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMSDCharacter_Statics::NewProp_AttributeSet = { "AttributeSet", nullptr, (EPropertyFlags)0x002008000008001c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMSDCharacter, AttributeSet), Z_Construct_UClass_UMSDPlayerAttributeSet_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMSDCharacter_Statics::NewProp_AttributeSet_MetaData), Z_Construct_UClass_AMSDCharacter_Statics::NewProp_AttributeSet_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMSDCharacter_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMSDCharacter_Statics::NewProp_MeleeProfile,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMSDCharacter_Statics::NewProp_AttributeSet,
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AMSDCharacter_Statics::InterfaceParams[] = {
			...
			{ Z_Construct_UClass_UPlayerInterface_NoRegister, (int32)VTABLE_OFFSET(AMSDCharacter, IPlayerInterface), false },  // 3953767536
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Caleb_Documents_Unreal_Projects_HordeShooterRepo_HordeShooter_Source_HordeShooter_Character_MSDCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMSDCharacter, AMSDCharacter::StaticClass, TEXT("AMSDCharacter"), &Z_Registration_Info_UClass_AMSDCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMSDCharacter), 2073174871U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Caleb_Documents_Unreal_Projects_HordeShooterRepo_HordeShooter_Source_HordeShooter_Character_MSDCharacter_h_2762513676(TEXT("/Script/HordeShooter"),
